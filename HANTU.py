...
def banner():
	print("""
     ...
     \33[37;1m
                         ...
                         +ddddddyo-    `hddh.    ohhyyhhdh ddd+   sddy                              
                         oMMNssmMMN:   +MMMMs   `yyyMMMdys mMMs   hMMh                              
                         +MMh  -MMMo  -mMMNMN:     -MMM+   dMMo   yMMy                              
                         +MMm//yMMN-  mMMs-MMm`    .MMM/   dMM+   yMMs                              
                         +MMMMMMMh-  :MMM+:NMMy    -MMM+   dMM+   sMMs                              
                         oMMd./MMN:  dMMMMMMMMM:   :MMM+   dMMh.`-dMMs                              
                         sMMd  sMMN./MMmoooodMMm`  /MMM+   sMMMmmNMMN-                              
                         :++/  `+++-/oo/    -ooo.  -ooo-   `:+sssso+-                               
                     ...
                     `````````  ``````     ```````        `...`     ```````                         
                    `mmmmmmmmy +ddmmmmhs- `ddmmmmdy/`  `/hmmNmds.  .ddmmmmdh+.                      
                    `MMMMmmmmh oMMNhdmMMN:`MMMdhdNMMh `yMMNmmmMMN+ `MMMmhdNMMd`                     
                    `MMMm...-. +MMd  .MMMo`NMM-  sMMM yMMm:` `oMMM+`NMMo  oMMM-                     
                    `NMMMNNNNo /MMmooyMMN-`NMMsoodMMh NMM:     mMMm`NMMhoodMMd                      
                    `NMMNhhhh: +MMMNNMMm: `NMMNNMMMs` mMM+    .NMMd`NMMNNMMMy.                      
                    `MMMN..... oMMm.:NMN: `MMM/.hMMh` +NMNs-./mMMm-`MMMo.hMMd.                      
                    `MMMMMMMMN`sMMN  sMMN.`MMM/ `dMMs  +NMMMMMMMh. -MMMo .NMMh                      
                    `yyyyyyyyy +yyy  .yyy/`yyy:  /yyy   .oyhdhs:   .yyy:  /yyy.                     
